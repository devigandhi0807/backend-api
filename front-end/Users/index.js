...
import ViewUserModal from 'containers/Users/viewUserModel';
const key = 'users';
  ...
  return (
    <div className="truthy-wrapper">
      ...
      <div className="truthy-table ">
        <UserTable onCreate={onCreate} onEdit={onEdit} onView={onView} />
      </div>
      <CreateUserModal
        visible={createUser}
      ...
      <ViewUserModal visible={viewUser} onCancel={() => setViewUser(false)} />
    </div>
  );
}
